...
public class Sample {
		...
		public static void main(String[] args) {
			...
			System.out.println("Common chars are: " + FindCharsShowUpInAllStringWordsArray(words1));

			String words2[] = { "cool", "lock", "cook" };
			System.out.println("Common chars are: " + FindCharsShowUpInAllStringWordsArray(words2));
	}
}
